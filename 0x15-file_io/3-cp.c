...
/**
 * check97 - checks for the correct arguments
 * @argc: arguments
 *
 * Return: void
 */
...
/**
 * check98 - checks for the existence of file_from and if it can be read
 * @check: checks
 * @file: file name
 * @fd_from: descriptor of file_from
...
/**
 * check99 - checks file_to creation and if more word scan be written to
 * @check: checks
 * @file: file name
 * @fd_from: descriptor of file_from
 * @fd_to: descriptor of file_to
...
/**
 * check100 - checks file descriptors for proper closing
 * @check: checks
 * @fd: file descriptor
 * Return: void
 */
...
{
	int fd_to, close_to, fd_from, close_from;
	ssize_t lenr, lenw;
	char buffer[1024];
	mode_t file_perm;
