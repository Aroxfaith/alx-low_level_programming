 ...
 * @e_ident: pointer to the array ELF magic numbers.
 */
void check_elf(unsigned char *e_ident)
{
	int index;
...
void print_magic(unsigned char *e_ident)
{
	...
	for (indent = 0; indent < EI_NIDENT; indent++)
	{
		printf("%02x", e_ident[index]);

		if (indent == EI_NIDENT - 1)
			printf("\n");
		else
			printf(" ");
	}
 ...
 * @e_ident: pointer to the array ELF class.
 */
void print_class(unsigned char *e_ident)
{
	printf("  Class:                             ");
 ...
 * @e_ident: pointer to the array ELF.
 */
void print_data(unsigned char *e_ident)
{
	printf("  Data:                              ");
 ...
 * @e_ident: pointer to the ELF version array.
 */
void print_version(unsigned char *e_ident)
{
	printf("  Version:                           %d",
 ...
 * @e_ident: pointer to the array ELF ABI.
 */
void print_abi(unsigned char *e_ident)
{
